    ...
    <div>
      <div>
        ...
        <p className="theText">
          ...
          are made so every user has a safe and pleasant experience both on the
          app and offline. Kindly respect the guidelines outlined below. Failure
          to do so may result in termination of your Findr account. If you find
          another user failing to follow the guidelines, do not hesitate to
          report their account.
        </p>
        <p className="theText">
          Findr is for networking and academic / business connections. Feel free
          to use Findr to find a study partner in your course, an assignment
          partner, someone to go to a Hackathon with, or even pitch a startup
          idea to. However, anyone seeking romantic connections must not use
          Findr.
        </p>
        <p className="theText">
          As exciting as it is to network and meet new individuals, at Findr we
          encourage our users to be cautious of the interactions they have.
          Safety is our number one priority. Below we have outlined ways to stay
        ...
        <ul className="privacy-list">
          <li>
            ...
            <ul className="privacy-list-nested">
              <li>
                Opt for an initial video call, or phone call before meeting the
                person in real life
              </li>
              <li>Meet in a public place for the initial meetings</li>
              <li>On the initial meetings stay in public</li>
              <li>
                Arrive and leave the place of the meeting on your own terms and
        ...
        <ul className="privacy-list">
          <li>
            ...
            <ul className="privacy-list-nested">
              ...
              <li>
                Do not share in-depth details of your usual routine with someone
                you do not know well (ex. What class you have on Mondays, where
                you go to drink coffee every Friday)
              </li>
              <li>
          ...
          <li>
            ...
            <ul className="privacy-list-nested">
              ...
              <li>
                Be wary of users that are impatient to meet. Users who are quick
                to request in-person meetings may not have the best intentions
              </li>
            </ul>
          </li>
        </ul>
      ...
      <div>
        <p className="theText">
          We at Findr know, even if users adhere to the above tips, it is still
          possible to be at risk or have a poor experience.
        </p>
        <p className="theText">
