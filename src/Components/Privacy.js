  ...
  return (
    <div className="legal-background">
      ...
      <div>
        ...
        <p className="theText">
          Maintaining the privacy of our users is our top priority. We recognise
          that your privacy is very important and we appreciate you trusting us
          with it. This Privacy Policy describes Findr’s policies and procedures
          on the collection, use, disclosure and sharing of your information
          when you use the Findr service via the Findr mobile application or the
          Findr website (For simplicity, we will refer to both these as our
      ...
      <div>
        ...
        <p className="theText">
          ...
          with peers from various fields and work more efficiently. Having said
          that, to help you find better and more meaningful connections, we
          would require some basic information including your basic profile
        ...
        <p className="theText">
          ...
          when you access our services through your canvas account. If you want
        ...
        <ul className="privacy-list">
          ...
          <li>
            ...
            on your courses, interests, projects and work experience. Here, you
            can also share with us details about your personality and a
            ...
            jurisdictions (for example, your gender, race or ethnic origins). By
          ...
          <li>
            If you choose to use the invite option on our service to invite your
            friends, we will ask for that friend’s email address and
            automatically send an email invitation. Findr collects your friend’s
            email address to automatically send the invitation and tracks if
            your invited friends accepted these requests. Doing so helps us keep
            a track of the success rate of these invitations. By providing your
            friend’s email addresses to us, you warrant that you have their
            consent to do so and for Findr to use this information as described
            above.{" "}
          </li>
        </ul>
        ...
        <p className="theText">
          In addition to the information you provide us, we receive information
          about you from other users, including:{" "}
        </p>
        <li className="privacy-list">
          Other users may provide information about you as they use our service.
          We may collect information about you from other users if they contact
          us about you (all the information listed above).
        </li>
        <h4 className="privacy-sub-title">
        ...
        <ul className="privacy-list">
          ...
          <li>
            ...
            device you’re using, including GPS, Bluetooth or Wi-Fi connections.
            The collection of your geolocation may occur in the background even
            when you aren’t using the services if the permission you gave us
            expressly permits such collection. If you decline permission for us
            to collect your geolocation, we will not collect it. Similarly, if
            you consent, we may collect your photos and videos.
          </li>
        </ul>
      </div>
      <div>
        ...
        <p className="theText">
          ...
          you and ensure you don’t have to log in each time you use our
          services.
        </p>
        <p className="theText">
        ...
        <p className="theText">
          <b>Session cookies</b> only last until you close your browser. We use
          sessional cookies to learn more about your use of our website during
          one browser session and help you use our website more efficiently.
        </p>
        <p className="theText">
        ...
        <ul className="privacy-list">
          <li>
            Authentication and security cookies. We use these cookies to enable
            you to remain logged into Findr, and verify that it is you as you
            use Findr. This helps keep your account safe and secure from
            unauthorized use, and helps combat spam and other abuse which
          ...
          <li>
            Product features and setting cookies. We use these cookies to enable
            the functionality of some features within the Findr product, in
            particular to personalize the experience towards you. We also use
            these cookies to store certain of your preferences and settings.
          </li>
        ...
        <ul className="privacy-list">
          ...
          <li>
            ...
            services and thereby personalise the preferences and cards that are
            shown to you.
          </li>
          <li>
            We use your data to link new devices to provide a consistent
            experience on using our services. We do this by linking the devices
            and browsing data.
          </li>
          <li>
          ...
          <li>
            We use the data you provide to perform data analysis to protect you
            and other users from any forbidden (refer to community guidelines)
        ...
        <ul className="privacy-list">
          <li>
            ...
            comfortable sharing since neither you nor us can control what others
            do once they see your information.
          </li>
          <li>
        ...
        <p className="theText">
          ...
          to the United States and/or to other countries for storage, processing
          and use by Findr in accordance with our Privacy Policy.
        </p>
        <p className="theText">
          ...
          and disclosure of such information is not subject to any restrictions
        ...
        <p className="theText">
          You may, of course, decline to submit information through the Service,
          in which case Findr may not be able to provide certain services to
          you. You may update or correct your account information and email
      ...
      <div>
        ...
        <p className="theText">
          Our services are restricted to users who are 13 years of age or older.
          We do not permit users under the age of 13 on our platform and we do
          not knowingly collect personal information from anyone under the age
          of 13. If you suspect that a user is under the age of 13, please use
