    ...
    <div>
      <div>
        ...
        <p className="theText">
          ...
          has a safe and pleasant experience both on the app and offline. Kindly
          respect the guidelines outlined below. Failure to do so may result in
          termination of your Findr account. If you find another user failing to
          follow the guidelines, do not hesitate to report their account.
        </p>
        <p className="theText">
      ...
      <div>
        ...
        <p className="theText">
          ...
          publicly or privately over the app. This includes, but is not limited
          to the following:
        </p>
      ...
      <div>
        ...
        <p className="theText">
          ...
          someone else. Do not post photos that are not of you, and upload only
          your own photos.
        </p>
      </div>
      <div>
        ...
        <ul className="privacy-list">
          ...
          <li>
            No pictures of work that is trademarked/copyrighted by another party
          </li>
          <li>No guns</li>
      ...
      <div>
        ...
        <p className="theText">
          ...
          comply with this may result in the termination of the user’s account.
        </p>
      </div>
      <div>
        ...
        <p className="theText">
          ...
          are firm believers of kindness and respect. We expect all of our uses
          to be accepting of each other, be mindful, respectful and kind at all
          times. Do not hesitate to report another user if they are found in
          violation of this, Findr will not tolerate rude and discriminatory
          behaviour.
        </p>
      </div>
    </div>
