    ...
    <div>
      <div>
        ...
        <ul className="privacy-list">
          ...
          <li>
            ...
            (collectively called the ‘Agreement’), each of which is incorporated
        ...
        <p className="theText">
          ...
          should regularly check the most recent version for any changes in the
          Agreement. If you continue to use the service after any revisions in
          the Agreement, then you agree to the Agreement.{" "}
        </p>
      </div>
      <div>
        ...
        <p className="theText">
          ...
          your account. Findr will not be liable for any loss or damage arising
          from your failure to comply with this instruction.
        </p>
        <p className="theText">
          If you are over the Minimum Age, but under the legal age of majority,
      ...
      <div>
        ...
        <p className="theText">
          ...
          another, it is not responsible for the conduct of any member on or off
          ...
          Service or meet in person. In addition, you agree to review and follow
          Findr’s{" "}
          <b>
            <Link
              to="/Safety"
        ...
        <p className="theText">
          ...
          YOU UNDERSTAND THAT FINDR DOES NOT CONDUCT CRIMINAL BACKGROUND CHECKS
          ON ITS MEMBERS OR OTHERWISE INQUIRE INTO THE BACKGROUND OF ITS
          MEMBERS. FINDR MAKES NO REPRESENTATIONS OR WARRANTIES AS TO THE
          CONDUCT OF MEMBERS
        </p>
      </div>
      <div>
        ...
        <p className="theText">
          Findr grants you a personal, worldwide, royalty-free, non-assignable,
          ...
          use and enjoy the Service’s benefits as intended by Findr and
        ...
        <ul className="privacy-list">
          ...
          <li>
            ...
            Service without Findr’s prior written consent.
          </li>
          <li>
            express or imply that any statements you make are endorsed by Findr.
          </li>
          <li>
          ...
          <li>
            use, access, or publish the Findr application programming interface
        ...
        <p className="theText">
          Findr may investigate and take any available legal action in response
      ...
      <div>
        ...
        <p className="theText">
          By creating an account, you grant to Findr a worldwide, transferable,
          sub-licensable, royalty-free, right a nd license to host, store, use,
          ...
          (collectively, "Content"). Findr’s license to your Content shall be
          non-exclusive, except that Findr’s license shall be exclusive with
          respect to derivative works created through use of the Service. You
          agree that any Content you place or that you authorize us to place on
          the Service may be viewed by other members and may be viewed by any
          person visiting or participating in the Service (such as individuals
          who may receive shared Content from other Findr members).
        </p>
        <p className="theText">
      ...
      <div>
        ...
        <p className="theText">
          Findr reserves the right to investigate and/ or terminate your account
          if you have violated this Agreement, misused the Service or behaved in
          a way that Findr regards as inappropriate or unlawful, including
      ...
      <div>
        ...
        <p className="theText">
          ...
          Company's Copyright Agent via email to <b>findr.study@gmail.com</b> or
      ...
      <div>
        ...
        <p className="theText">
          FINDR PROVIDES THE SERVICE ON AN “AS IS” AND “AS AVAILABLE” BASIS AND
          ...
          FINDR DOES NOT REPRESENT OR WARRANT THAT (A) THE SERVICE WILL BE
      ...
      <div>
        ...
        <p className="theText">
          ...
          CONDUCT OR CONTENT OF OTHER MEMBERS OR THIRD PARTIES ON, THROUGH, OR
          FOLLOWING USE OF THE SERVICE; OR (III) UNAUTHORIZED ACCESS, USE OR
          ALTERATION OF YOUR CONTENT, EVEN IF FINDR HAS BEEN ADVISED OF THE
          POSSIBILITY OF SUCH DAMAGES. IN NO EVENT WILL FINDR’S AGGREGATE
          LIABILITY TO YOU FOR ALL CLAIMS RELATING TO THE SERVICE EXCEED THE
          GREATER OF THE AMOUNT PAID, IF ANY, BY YOU TO FINDR FOR THE SERVICE
          AND USD100 WHILE YOU HAVE AN ACCOUNT.
        </p>
        <p className="theText">
      ...
      <div>
        ...
        <p className="theText">
          Except if you opt-out or for disputes relating to: (1) your or Findr’s
          intellectual property (such as trademarks, trade dress, domain names,
          trade secrets, copyrights and patents, you agree that all disputes
          between you and Findr (whether or not such dispute involves a third
          party) with regard to your relationship with Findr, including without
          limitation disputes related to these Terms of Use, your use of the
          Service, and/or rights of privacy and/or publicity, will be resolved
          by binding, individual arbitration under the Canadian Arbitration
          Association's rules for arbitration of consumer-related disputes and
          you and Findr hereby expressly waive trial by jury. As an alternative,
          you may bring your claim in your local "small claims" court, if
          permitted by that small claims court's rules. You may bring claims
          only on your own behalf. Neither you nor Findr will participate in a
          class action or class-wide arbitration for any claims covered by this
          agreement. You also agree not to participate in claims brought in a
          private attorney general or representative capacity, or consolidated
          claims involving another person's account, if Findr is a party to the
          proceeding. This dispute resolution provision will be governed by the
          Ontario Arbitration Act, 1991. In the event the Canadian Arbitration
          Association is unwilling or unable to set a hearing date within one
          hundred and sixty (160) days of filing the case, then either Findr or
          you can elect to have the arbitration administered instead by the
        ...
        <p className="theText">
          ...
          you nor Findr can require the other to participate in an arbitration
          proceeding. To opt out, you must notify Findr in writing within 30
          days of the date that you first became subject to this arbitration
          provision. You must use this address to opt out: Findr, 3025 The
          Credit Woodlands, Mississauga, ON L5C 2V3.
        </p>
        <p className="theText">
          You must include your name and residence address, the email address
          you use for your Findr account, and a clear statement that you want to
        ...
        <p className="theText">
          ...
          of your relationship with Findr.
        </p>
      </div>
      <div>
        ...
        <p className="theText">
          ...
          defend and hold harmless Findr, our affiliates, and their and our
      ...
      <div>
        ...
        <p className="theText">
          ...
          You agree that your Findr account is non-transferable and all of your
          ...
          and you may not make any representations on behalf of or bind Findr in
          any manner.
        </p>
      </div>
    </div>
